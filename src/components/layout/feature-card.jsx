...
export function FeatureCard() {
    return (
        <div className="container mx-auto max-w-5xl py-8 mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 feature-bg py-8">
                <HoverBorderGradient containerClassName={'rounded-lg'} className={'bg-white p-6 space-y-4 shadow-md '} as='div'>
                    <ChartColumnBig className='text-black' />
                ...
                <HoverBorderGradient containerClassName={'rounded-lg'} className={'bg-white p-6 space-y-4 shadow-md h-full'} as='div'>
